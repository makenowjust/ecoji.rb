...
file 'lib/ecoji/emojis.rb' => %w[deps/ecoji/emojisV1.txt deps/ecoji/emojisV2.txt] do
  v1 = File.read('deps/ecoji/emojisV1.txt').lines(chomp: true)
  v2 = File.read('deps/ecoji/emojisV2.txt').lines(chomp: true)
